...
const ConstructionSchedule = () => {
  ...
  // В файле ConstructionSchedule.js найдите функцию addNewRow и исправьте:
  ...
  const addNewRow = () => {
    ...
    const newRow = {
      id: `new-${Date.now()}`,
      schedule_type: 'construction', // ✅ Исправлено! Было 'procurement'
      construction_stage: '',
      work_name: '',
      workers_count: '', // Убираем лишние поля для construction
      planned_start_date: '',
      planned_end_date: '',
